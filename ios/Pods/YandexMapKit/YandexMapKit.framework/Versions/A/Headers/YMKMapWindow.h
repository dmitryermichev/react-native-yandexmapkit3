 ...
 */
@interface YMKMapWindow : YRTPlatformBinding
...
/**
 * Defines the focus point of map zooming for double tap and multi tap
 * gestures. If the point is not set, the source point of the gesture
 * will be used as the focus point. Default: none.
 *
 * Optional property, can be nil.
 */
