 ...
 */
@property (nonatomic, copy) NSValue *anchor;
 ...
 * Optional property, can be null.
 */
@property (nonatomic, copy) NSNumber *rotationType;
 ...
 * Optional property, can be null.
 */
@property (nonatomic, copy) NSNumber *flat;
 ...
 * Optional property, can be null.
 */
@property (nonatomic, copy) NSNumber *visible;
 ...
 * Optional property, can be null.
 */
@property (nonatomic, strong) YMKRect *tappableArea;
