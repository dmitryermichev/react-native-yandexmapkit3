...
@property (nonatomic, readonly) YMKGeoObject *obj;

@property (nonatomic, readonly) YMKGeoObjectCollection *collection;

+ (YMKGeoObjectCollectionItem *)itemWithObj:(YMKGeoObject *)obj;

+ (YMKGeoObjectCollectionItem *)itemWithCollection:(YMKGeoObjectCollection *)collection;
